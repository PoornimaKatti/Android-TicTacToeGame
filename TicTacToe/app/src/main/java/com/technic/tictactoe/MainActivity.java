...
import com.technic.tictactoe.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = com.technic.tictactoe.databinding.ActivityMainBinding.inflate(getLayoutInflater());
    ...
    private void performAction(ImageView imageView, int selectedBoxPosition) {
        ...
        if (playerTurn == 1) {
            ...
            if (checkResults()) {
                ...
                ResultDialog resultDialog = new ResultDialog(MainActivity.this, "MatchDraw", MainActivity.this);
                resultDialog.setCancelable(false);
                resultDialog.show();
            } else {
                changePlayerTurn(2);
            ...
            imageView.setImageResource(R.drawable.o1image);
            if (checkResults()) {
    ...
    private  boolean isBoxSelection(int boxpostion)
    {
        boolean response = false;
